...
def generate_for_process_model(process_model, size=5000, anomalies=None, anomaly_p=0.3, num_attr=0,
    ...
    event_attributes = [
        ...
        CategoricalAttributeGenerator(name='weekday', values=working_days, domain=week_days, min_group=2, max_group=5),
        CategoricalAttributeGenerator(name='xountry', values=countries, min_group=1, max_group=5),
        CategoricalAttributeGenerator(name='zompany', values=company_names, min_group=1, max_group=5)
    ]
